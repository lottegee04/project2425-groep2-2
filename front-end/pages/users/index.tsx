...
const Users: React.FC = () => {
  ...
  return (
    ...
    {loggedInUser && `${loggedInUser.role === "admin"? "All Users (admin)": `User: ${loggedInUser.username}`}`}</h1>
    {!error && <p className='align-self-center'>Click on the user to see their tasks.</p>}
